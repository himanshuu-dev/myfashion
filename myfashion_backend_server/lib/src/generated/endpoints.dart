...
import '../example/example_endpoint.dart' as _i4;
        ...
        'greet': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['example'] as _i4.ExampleEndpoint).greet(
                session,
                params['name'],
              ),
        ),
        'abuse': _i1.MethodConnector(
          name: 'abuse',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['example'] as _i4.ExampleEndpoint).abuse(
                session,
                params['name'],
              ),
        ),
        'love': _i1.MethodConnector(
          name: 'love',
          params: {
            'name': _i1.ParameterDescription(
              name: 'name',
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['example'] as _i4.ExampleEndpoint).love(
                session,
                params['name'],
              ),
        ),
